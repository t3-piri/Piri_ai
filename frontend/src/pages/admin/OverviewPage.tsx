...
export default function OverviewPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    Promise.all([apiGet("/api/admin/documents"), apiGet("/api/admin/unanswered")])
      .then(([d, u]) => {
        if (cancelled) return;
        setDocs(d);
        setUnanswered(u);
  ...
  return (
    <>
      ...
      <GlowCard glowColor="blue" className="rounded-xl bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-[rgba(255,255,255,0.08)] p-5 shadow-[0_4px_8px_rgba(0,0,0,0.08)]">
        ...
        <div className="grid md:grid-cols-3 gap-5 mt-5">
          {[
            ...
            <GlowCard
              key={x.k}
              glowColor={(["green", "orange", "purple"] as const)[i]}
      ...
      <div className="grid md:grid-cols-3 gap-6 items-stretch">
        <GlowCard
          glowColor="purple"
          className="md:col-span-2 rounded-xl bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-[rgba(255,255,255,0.08)] p-5 shadow-[0_4px_8px_rgba(0,0,0,0.08)] flex flex-col h-full max-h-[300px] overflow-hidden"
        >
        ...
        <GlowCard
          glowColor="orange"
          className="rounded-xl bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-[rgba(255,255,255,0.08)] p-5 shadow-[0_4px_8px_rgba(0,0,0,0.08)] flex flex-col h-full max-h-[300px]"
        >
